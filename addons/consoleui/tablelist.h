...
namespace ui {
	std::string create_stringlist(std::vector<std::string> s, int x, int y, int per = 3);
	void set_stringlist(TableList *tablelist, std::vector<std::string> vec_s, int x, int y, int per = 3);
